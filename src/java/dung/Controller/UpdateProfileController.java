...
public class UpdateProfileController extends HttpServlet {
    ...
    private final static String SUCCESS = "profile.jsp";
    private final static String INVALID = "profile.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (valid) {
                ...
                if (beans.UpdateProfile()) {
                    url = SUCCESS;
                    request.setAttribute("OK", "Update profile successfull!!!");
                    UserDto dto = new UserDto(username, password, Email, url, fullname, address, phoneNo);
