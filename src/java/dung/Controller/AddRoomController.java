...
public class AddRoomController extends HttpServlet {
    ...
    private static final String INVALID = "addNewRoom.jsp";
    private static final String SUCCESS = "managerRoom.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (valid) {
                ...
                beans.setDateIn(DateAdd);
                beans.setDateOut(DateAdd);
                if (beans.addNewRoom()) {
                    url = SUCCESS;
                }
            } else {
            ...
            if (e.getMessage().contains("duplicate")) {
                erroObj.setRoomidExist("Room Id is exist");
                request.setAttribute("INVALID", erroObj);
            }
        } finally {
